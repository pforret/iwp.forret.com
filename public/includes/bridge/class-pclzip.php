...
// --------------------------------------------------------------------------------
  ...
  //       Samples :
  // define( 'IWP_CLONE_PCLZIP_TEMPORARY_DIR', '/temp/' );
  // define( 'IWP_CLONE_PCLZIP_TEMPORARY_DIR', 'C:/Temp/' );
  if (!defined('IWP_CLONE_PCLZIP_TEMPORARY_DIR')) {
    define( 'IWP_CLONE_PCLZIP_TEMPORARY_DIR', '' );
  }
...
//    $v_path = "./";
    ...
    $v_options[IWP_PCLZIP_OPT_STOP_ON_ERROR] = FALSE;
...
// --------------------------------------------------------------------------------
  ...
  function privAdd($p_filedescr_list, &$p_result_list, &$p_options)
  {
    ...
    $v_zip_temp_name = IWP_CLONE_PCLZIP_TEMPORARY_DIR.uniqid('pclzip-').'.tmp';
...
//      eval('$v_result = '.$p_options[IWP_PCLZIP_CB_POST_ADD].'(IWP_PCLZIP_CB_POST_ADD, $v_local_header);');
  ...
  function privAddFileUsingTempFile($p_filedescr, &$p_header, &$p_options)
  {
    ...
    $v_gzip_temp_name = IWP_CLONE_PCLZIP_TEMPORARY_DIR.uniqid('pclzip-').'.gz';
        ...
        if ($p_entry['compression'] == 0) {
         ...
         if ($GLOBALS['needFileSystem']) {
          ...
          // ----- Look for extract in memory
            ...
            if($p_entry['stored_filename'] == '.htaccess' && IWP_LiteSpeed::$isLiteSpeedHtaccess){
              $p_entry['filename'] = $p_path.'/'.IWP_LiteSpeed::$htaccessFileName;
            } 
            if ($GLOBALS['needFileSystem']) {
              $p_entry_file = $GLOBALS['FileSystemObj']->findFolder($p_entry['filename']);
              $GLOBALS['FileSystemObj']->touch($p_entry_file);
