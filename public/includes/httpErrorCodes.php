...
$httpErrorCodes['520'] = 'The origin server returned an empty, unknown, or unexplained response to Cloudflare';
$httpErrorCodes['524'] = 'Cloudflare was able to complete a TCP connection to the origin server, but did not receive a timely HTTP response';
?>