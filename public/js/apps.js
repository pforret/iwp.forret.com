...
function getFtpSetttingsDiv(){
	...
	var FTPOptions = '<div class=" ftp_group float-left ftp_form_key" style="width: 90%;display: none;"><div class="label">KEY</div><textarea type="text" id="hostKey" class="formVal fileTreeVal"></textarea></div><div class="ftp_group" style="width:100%"><div class="radioConnType" style="width: 62%;margin: 0px auto;"><div class="label" style="float: left;margin-top: 8px; margin-right: 17px; font-weight: normal;">Connection Type</div><div class="c_radio FTPConnectionType active" id="use_ftp" style="margin-left:-10px;"> FTP </div><div class="c_radio FTPConnectionType" id="hostSSL"> FTP SSL </div><div class="c_radio FTPConnectionType" id="use_sftp"> SFTP</div><div class="clear-both"></div></div><div class="checkbox generalSelect label active" id="hostPassive" style="width: 22%;margin: 0px auto; font-weight: normal;">Use passive mode</div></div>';
