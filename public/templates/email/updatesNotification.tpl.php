...
?>
  <tr>
   ...
   <tr>
    ...
    <td width="340"><span <?php if(!empty($update['vulnerability'])){ echo 'style="color:#f44336;"';} ?> ><?php echo 'v'. strip_tags($update['current_version'])?> </span> <?php echo ' to '.'<a href="'.WP_CHANGELOG_URL.'Version-'.strip_tags($update['current']).'/ "style="color: #49a1de;">v'. strip_tags($update['current']);?> <?php if(!empty($update['vulnerability'])){ ?> <img style="width: 13px;float: inherit;margin-left: 7px;" src="https://s3.amazonaws.com/iwp_images/vulnsIcon.png"> <?php  } ?></td>
  </tr>
  <?php } }
  ?>
